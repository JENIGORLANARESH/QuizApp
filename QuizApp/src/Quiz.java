...
public class Quiz implements ActionListener{
	...
	String[][] options = {
		    {"3", "4", "5", "6"},
		    {"William Shakespeare", "Charles Dickens", "Mark Twain", "George Orwell"},
		    {"H2O", "CO2", "O2", "N2"},
		    {"Atlantic", "Indian", "Arctic", "Pacific"},
		    {"Central Processing Unit", "Central Programming Unit", "Computer Personal Unit", "Control Panel Unit"},
	...
	char[] answers = {'B', 'A', 'A', 'D', 'A', 'C', 'A', 'D', 'B', 'A'};
	char guess;
	char answer;
	int index;
